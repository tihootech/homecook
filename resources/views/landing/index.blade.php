        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active"><a href="#" class="nav-link"> <i class="material-icons">home</i> صفحه اصلی </a></li>
                    <li class="nav-item"><a href="#" class="nav-link"> <i class="material-icons">fastfood</i> سفارش غذا </a></li>
                    <li class="nav-item"><a href="#" class="nav-link"> <i class="material-icons">menu_book</i> مطالب منتشر شده </a></li>
                    <li class="nav-item"><a href="#" class="nav-link"> <i class="material-icons">person_pin</i> در باره ما </a></li>
                    <li class="nav-item"><a href="#" class="nav-link"> <i class="material-icons">phone_in_talk</i> تماس با ما </a></li>
                    <li class="nav-item"><a href="#" class="nav-link"> <i class="material-icons">how_to_reg</i> همکاری </a></li>
                ...
                <div class="col-lg-2 col-md-6 mb-5 mb-md-5">
                    <div class="ftco-footer-widget mb-4 ml-md-4">
                        ...
                        <ul class="list-unstyled p-0">
                            <li><a href="#" class="py-2 d-block"> همکاری با ما </a></li>
